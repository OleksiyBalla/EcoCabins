(() => {
    ...
    const heroTexts = {
        hero_title: {
            uk: "Екологічний маленький будинок побудований, наскільки це можливо, з використанням стійких природних матеріалів.",
            en: "Een ecologisch tiny huisje is zoveel mogelijk opgebouwd uit duurzame natuurlijke materialen"
        }
    };
    function checkPagePathName() {
        switch (currentPathName) {
          case "/home.html":
            currentTexts = heroTexts;
            break;
